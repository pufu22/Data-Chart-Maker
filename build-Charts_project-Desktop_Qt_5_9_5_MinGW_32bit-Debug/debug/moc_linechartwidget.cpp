...
#include "../../Charts_project/view/linechartwidget.h"
...
QT_MOC_LITERAL(5, 55, 14), // "togliLineaSlot"
QT_MOC_LITERAL(6, 70, 14), // "togliPuntoSlot"
QT_MOC_LITERAL(7, 85, 16), // "cambiaTitoloSlot"
QT_MOC_LITERAL(8, 102, 13) // "salvaJsonFile"

    },
    "LineChartWidget\0linea\0\0aggiungilineaslot\0"
    "aggiungipunto\0togliLineaSlot\0"
    "togliPuntoSlot\0cambiaTitoloSlot\0"
    "salvaJsonFile"
};
...
void LineChartWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->togliLineaSlot(); break;
        case 4: _t->togliPuntoSlot(); break;
        case 5: _t->cambiaTitoloSlot(); break;
        case 6: _t->salvaJsonFile(); break;
        default: ;
        }
